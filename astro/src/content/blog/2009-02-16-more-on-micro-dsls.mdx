...
pubDate: "2009-02-16"
categories: 'java'
keywords: "micro-DSL, fluent API, domain-specific language, Java, method chaining, collections, type-safe"
description: "Another micro-DSL example: a fluent find-in-list API. Shows how to build a natural, readable DSL for searching heterogeneous collections in Java."
---
