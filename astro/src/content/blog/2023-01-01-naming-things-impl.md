...
# Implementing classes that end with Impl

What's the main reason to have an interface in Java?

If you can't remember why you're creating interfaces or if you postfix the name of your implementation with `Impl`, then you've probably picked up a habit. Guess what? Its hurting you.
