...
import ClickToEnlarge from '../../components/ui/ClickToEnlarge.astro';
...
<ClickToEnlarge src={screenshot} alt="The temperature-machine UI" />
...
<ClickToEnlarge src={addon1} alt="Add on board for temperature-machine" width={266} height={200} />
<ClickToEnlarge src={addon2} alt="Add on board for temperature-machine" width={266} height={200} />
<ClickToEnlarge src={addon3} alt="Add on board for temperature-machine" width={266} height={200} />
<ClickToEnlarge src={addon4} alt="Add on board for temperature-machine" width={266} height={200} />
