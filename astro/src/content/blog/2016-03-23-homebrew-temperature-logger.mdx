...
<Image src={addon1} alt="Add on board for temperature-machine" width="266" height="200"/>
<Image src={addon2} alt="Add on board for temperature-machine" width="266" height="200"/>
<Image src={addon3} alt="Add on board for temperature-machine" width="266" height="200"/>
<Image src={addon4} alt="Add on board for temperature-machine" width="266" height="200"/>
