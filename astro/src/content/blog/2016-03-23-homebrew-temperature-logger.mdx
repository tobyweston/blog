...
keywords: "Raspberry Pi, temperature logger, DS18B20, Pi Zero, IoT, home automation, Scala, data logging"
description: "Build a home brew temperature logger for around $10 using a Raspberry Pi Zero and DS18B20 temperature sensor. Great starter IoT project with Scala server."
