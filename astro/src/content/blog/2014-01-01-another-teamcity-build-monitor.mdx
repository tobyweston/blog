...
pubDate: '2014-01-01'
categories: 'java'
keywords: "TeamCity, build monitor, build radiator, continuous integration, CI, screen saver, Windows, Radiate"
description: "Radiate is a TeamCity build monitor that aggregates all build statuses into a single pass/fail — no cherry-picking which failures to ignore."
---
