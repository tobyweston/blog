...
pubDate: '2021-01-04'
categories: 'agile'
keywords: "pull requests, trust, code review, GitHub, git-request-pull, open source, collaboration, team culture"
description: "A history of pull requests: from Linus Torvalds' original git-request-pull to GitHub's PR feature, and what it means for trust and collaboration in your team."
---

## A (Sketchy) History of the Pull Request

The nomenclature "pull request" actually came out of GitHub where they we're using the git-request-pull command as the basis of their new feature to manage code reviews and merges. From a Git perspective (and [Linus'](https://github.com/torvalds/linux/pull/17#issuecomment-5654674), a third party can request a project "pull" potential changes into their internal repository - it's literally a request to pull changes from some other repo. From the GitHub product perspective, Pull Requests (PRs) were designed to help review and integrate code from third parties via their platform. The need for which stems from the open source community where we try and encouraging contribution from the public.

![](git-request-pull.png)
...
It's worth noting too that this is different from **sharing knowledge**8. PRs are not a great mechanism for this as that goal can compete with code review goals. Unless the entire team is going to review a PR, you won't even come close. Frequently collaborating and working on the same problems is what helps to avoid silos.

{% pullquote %}
Using pull requests for code changes by your own team members is like having your family members go through an airport security checkpoint to enter your home. It's a costly solution to a different problem. Kief Morris - Thoughtworks
{% endpullquote %}
