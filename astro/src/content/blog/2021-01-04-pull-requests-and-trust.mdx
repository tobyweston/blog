...
It's worth noting that this is different from **sharing knowledge**8. PRs are not a great mechanism for this as that goal can compete with code review goals. Unless the entire team is going to review a PR, you won't even come close. Frequently collaborating and working on the same problems is what helps to avoid silos.
