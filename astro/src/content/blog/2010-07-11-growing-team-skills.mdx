...
keywords: "team skills, competency matrix, gap analysis, agile coaching, skill chart, technical skills, developer growth"
description: "Use a competency depth distribution chart to visualise your team's skills and identify gaps. A practical tool for agile coaches to guide training and development."
---

import ImgTag from '../../components/ImgTag.astro';
import depthChart from '../images/depth-chart.png';
...
<a href={depthChart}>
  <ImgTag src={depthChart} width={640} height={342} alt="Competency Depth Distribution Chart" title="Competency Depth Distribution Chart" />
</a>
