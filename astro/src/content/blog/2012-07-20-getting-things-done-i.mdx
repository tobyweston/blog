...
pubDate: "2012-07-20"
categories: 'agile'
keywords: "GTD, Getting Things Done, David Allen, task management, productivity, stress-free, agile, Appigo Todo"
description: "An introduction to Getting Things Done (GTD) — David Allen's system for stress-free productivity. How it compares with agile practices and how to get started."
series: "Getting Things Done"
---

import { Image } from 'astro:assets';

import gtd_basic from "../images/gtd-basic.png";
...
<Image src={gtd_basic} alt="Abbreviated workflow" width="350" height="467"/>
