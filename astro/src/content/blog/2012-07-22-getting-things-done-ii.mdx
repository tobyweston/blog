...
pubDate: "2012-07-22"
categories: 'agile'
keywords: "GTD, Getting Things Done, inbox zero, next actions, weekly review, projects, productivity system"
description: "Part two of Getting Things Done: dig into the GTD workflow — collecting, processing, organising, reviewing, and doing. Practical tips for making GTD work day to day."
series: "Getting Things Done"
---


import { Image } from 'astro:assets';
import appigo_todo from "../images/appigo_todo.png";


<Image src={appigo_todo} alt="My Lists in Appigo Tod" width="224" height="336" />


In the [preceding post](/blog/2012-07-20-getting-things-done-i), I summarised some of the ideas from David Allen's book [Getting Things Done](http://amzn.to/Tm1FdQ). In this second post, I talk more about trying to apply the basic ideas with more rigour and reflect on how it's been going. I also draw parallels between Allen's ideas and some of the principles that underpin modern agile software development.
