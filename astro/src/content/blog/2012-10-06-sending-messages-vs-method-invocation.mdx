...
keywords: "message passing, method invocation, OOP, Alan Kay, encapsulation, object-oriented design, Smalltalk"
description: "Alan Kay's original vision of OOP was about message passing, not method calls. Explores the conceptual difference and why it matters for good object-oriented design."
---

import ImgTag from '../../components/ImgTag.astro';
import mail from '../images/letter.jpg';

[<ImgTag class="right" src={mail} alt="Sending..." />]({mail})
