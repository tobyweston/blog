...
subTitle: "Using generics to create flexible, type-safe fluent APIs in Java"
pubDate: "2009-02-23"
categories: 'java testing'
keywords: "Java generics, type inference, fluent API, micro-DSL, wildcard, type safety, NeedleFinder"
description: "Java struggles with type inference when multiple generics are in play. Examines how to work around these limitations when building a generic fluent find-in-list DSL."
---
